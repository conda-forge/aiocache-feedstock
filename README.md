...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiocache-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14297&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiocache-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiocache` can be installed with:

```
conda install aiocache
```

It is possible to list all of the versions of `aiocache` available on your platform with:
